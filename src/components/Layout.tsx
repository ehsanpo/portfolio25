...
const navigation = [
  ...
  { id: "i18n", name: "Internationalization", icon: MessageCircle },
  { id: "navigation", name: "Site Navigation", icon: Menu },
  ...
  { id: "portfolio-demo", name: "Portfolio Demo", icon: User },
];
            ...
            <nav className="px-4 space-y-2">
              {navigation.map((item) => {
                ...
                const isActive =
                  ...
                  (isComponents && activeSection.startsWith("components-"));
                if (isComponents) {
                  return (
                    <div key={item.id}>
                      <button
                      ...
                      {isComponentsOpen && (
                        <div className="mt-2 ml-4 space-y-1 border-l border-border/30 pl-4">
                          {componentSubSections.map((subItem) => {
                            ...
                            const isSubActive =
                              activeSection === "components" &&
                              activeComponentSection === subItem.id;
