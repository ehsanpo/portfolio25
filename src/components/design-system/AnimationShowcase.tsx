    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Comprehensive animation system with gradients, scrolling, marquees,
          and visual effects.
        </p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <Badge variant="glass">{isPlaying ? "Running" : "Paused"}</Badge>
          </div>
        </Card>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            8s linear infinite gradient background animation
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
              <div className="p-8 rounded-lg bg-gradient-to-r from-primary-500 to-secondary-500 animate-gradient text-center">
                ...
                <p className="text-white/80 font-kabel">
                  Background size and position animate continuously
                </p>
              </div>
...
50%: background-size: 300% 300%, background-position: right center`}
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            30s linear infinite horizontal scrolling
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
                ...
                >
                  <div className="flex space-x-8 min-w-full">
                    <div className="flex items-center space-x-2 bg-primary-500/20 px-4 py-2 rounded-lg">
                      ...
                      <span className="font-kabel text-foreground">
                        Scrolling Item 1
                      </span>
                    </div>
...
to: transform: translateX(calc(-100% - var(--gap)))`}
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Vertical marquee with variable duration and gap
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
              <div className="h-48 overflow-hidden bg-muted/30 rounded-lg p-4">
                <div
                  className={`flex flex-col space-y-4 ${
                    isPlaying ? "animate-marquee-vertical" : ""
                  }`}
                  style={
                    {
                      "--duration": "12s",
...
to: transform: translateY(calc(-100% - var(--gap)))`}
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardDescription className="font-kabel text-white/80">
            Animated reveal effect with gradient overlay
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
