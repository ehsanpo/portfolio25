...
export function AudioPlayerDemo() {
  ...
  const demoTracks = [
    ...
    },
    {
      ...
      genre: "Electronic",
      description:
        "Futuristic electronic music with heavy bass and synth leads",
    },
  ];
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        <h2 className="text-3xl font-bold font-basement gradient-text mb-4">
          Global Audio Player Demo
        </h2>
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Experience our global audio player with a curated collection of
          tracks. Click any play button to start listening!
        </p>
      </div>
      ...
      <div className="grid gap-8">
            ...
            <div className="flex items-center space-x-4">
              {currentTrack ? (
                <>
                  ...
                  <div>
                    <h3 className="font-basement text-white text-lg">
                      {currentTrack.title}
                    </h3>
                ...
                <div className="text-center">
                  ...
                  <p className="text-white/60 font-kabel text-sm">
                    Choose a track below to start listening
                  </p>
                </div>
              )}
            </div>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Popular tracks to get you started
          </CardDescription>
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {demoTracks.slice(0, 4).map((track) => (
                <div
                  key={track.id}
                  className="p-4 glass-card rounded-lg text-center group hover:scale-105 transition-transform"
                >
                  ...
                  <h4 className="font-basement text-foreground text-sm mb-1">
                    {track.title}
                  </h4>
                  <p className="text-xs text-muted-foreground font-kabel mb-3">
                    {track.artist}
                  </p>
                  <PlayButton
                    track={track}
              ...
              <CardContent>
                <div className="space-y-3">
                  {tracks.map((track, index) => (
                    <div
                      key={track.id}
                      className="flex items-center justify-between p-4 glass-card rounded-lg hover:bg-muted/50 transition-colors group"
                    >
                      <div className="flex items-center space-x-4 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-3">
                            <div className="flex-1 min-w-0">
                              <h4 className="font-basement text-foreground text-sm truncate">
                                {track.title}
                              </h4>
                              <p className="text-xs text-muted-foreground font-kabel truncate">
                                {track.artist}
                              </p>
                            </div>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            What makes our global audio player special
          </CardDescription>
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center p-4 glass-card rounded-lg">
                ...
                <p className="text-xs text-muted-foreground font-kabel">
                  Real-time visual feedback with animated bars that respond to
                  the music
                </p>
              </div>
              ...
              <div className="text-center p-4 glass-card rounded-lg">
                ...
                <p className="text-xs text-muted-foreground font-kabel">
                  Play tracks from anywhere in the app - music continues as you
                  navigate
                </p>
              </div>
              ...
              <div className="text-center p-4 glass-card rounded-lg">
                ...
                <p className="text-xs text-muted-foreground font-kabel">
                  Automatically builds playlists as you play tracks with
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-basement text-foreground mb-1">
                    Click Any Play Button
                  </h4>
                  <p className="text-sm text-muted-foreground font-kabel">
                    Click any play button on this page to start playing a track
                    in the global player at the bottom of the screen.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground font-kabel">
                    The visual equalizer in the center of the player animates in
                    real-time with the music playback.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground font-kabel">
                    Music continues playing as you navigate to other sections of
                    the design system.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground font-kabel">
                    Use the controls in the global player or the status card
                    above to pause, skip, or adjust volume.
                  </p>
                </div>
              </div>
            </div>
