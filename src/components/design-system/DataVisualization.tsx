    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Guidelines for creating clear, accessible, and beautiful data
          visualizations that align with our design system.
        </p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <p className="text-lg text-white/90 font-kabel leading-relaxed mb-6">
            Great data visualization transforms complex information into clear,
            actionable insights. Our approach prioritizes clarity over
            decoration, accessibility over aesthetics, and user understanding
            over visual complexity. Every chart should tell a story and guide
            decision-making.
          </p>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Common visualization patterns and their applications
          </CardDescription>
          <CardContent>
                ...
                return (
                  <div key={index} className="p-4 glass-card rounded-lg">
                    <div className="flex items-start space-x-4 mb-4">
                      ...
                      <div>
                        <h4 className="font-semibold font-basement text-foreground mb-1">
                          {chart.name}
                        </h4>
                    ...
                    <div className="mb-4">
                      <h5 className="text-sm font-medium font-basement text-foreground mb-2">
                        Best for:
                      </h5>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Carefully selected color schemes for different data types
          </CardDescription>
          <CardContent>
              ...
              {colorPalettes.map((palette, index) => (
                <div key={index} className="p-4 glass-card rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <h4 className="font-semibold font-basement text-foreground">
                        {palette.name}
                      </h4>
                      <p className="text-sm text-muted-foreground font-kabel">
                        {palette.description}
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Sample charts demonstrating our design principles
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              {/* Bar Chart Example */}
                ...
                <div className="p-6 glass-card rounded-lg">
                  <div className="flex items-end justify-between h-32 mb-4">
                    <div className="flex flex-col items-center">
                      <div
                        className="w-8 bg-primary-500 rounded-t mb-2"
                        style={{ height: "60%" }}
                      ></div>
                      <span className="text-xs font-kabel text-muted-foreground">
                        Q1
                      </span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div
                        className="w-8 bg-secondary-500 rounded-t mb-2"
                        style={{ height: "80%" }}
                      ></div>
                      <span className="text-xs font-kabel text-muted-foreground">
                        Q2
                    ...
                    <div className="flex flex-col items-center">
                      <div
                        className="w-8 bg-accent-500 rounded-t mb-2"
                        style={{ height: "100%" }}
                      ></div>
                      <span className="text-xs font-kabel text-muted-foreground">
                        Q3
                    ...
                    <div className="flex flex-col items-center">
                      <div
                        className="w-8 bg-warning-500 rounded-t mb-2"
                        style={{ height: "70%" }}
                      ></div>
                      <span className="text-xs font-kabel text-muted-foreground">
                        Q4
                  ...
                  <h5 className="font-basement text-foreground text-center">
              ...
              <div>
                ...
                <div className="p-6 glass-card rounded-lg">
                  ...
                  <h5 className="font-basement text-foreground text-center mt-4">
                    Traffic Sources
                  </h5>
                </div>
              </div>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Recommended libraries and tools for creating visualizations
          </CardDescription>
          <CardContent>
