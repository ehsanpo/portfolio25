  ...
  const usageGuidelines = [
    {
      ...
      avoid: [
        "Different icons for same function",
        "Mixed icon styles",
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Our icon system provides clear, consistent visual communication
          through carefully selected and styled symbols.
        </p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <p className="text-lg text-white/90 font-kabel leading-relaxed mb-6">
            Icons are a universal language that transcends cultural and
            linguistic barriers. Our iconography prioritizes clarity,
            consistency, and recognition. We use the Lucide icon library as our
            foundation, ensuring a cohesive visual system with excellent
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Our complete icon set organized by category
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4">
                    {category.icons.map((iconItem, iconIndex) => {
                      ...
                      return (
                        <div
                          key={iconIndex}
                          className="flex flex-col items-center p-3 glass-card rounded-lg hover:bg-primary-500/10 transition-colors group"
                        >
                          <IconComponent className="w-6 h-6 text-foreground group-hover:text-primary-500 transition-colors mb-2" />
                          <span className="text-xs text-muted-foreground font-kabel text-center">
                            {iconItem.name}
                          </span>
                        </div>
                      );
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Standardized sizes for different use cases
          </CardDescription>
          <CardContent>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            How icons are used in different contexts
          </CardDescription>
          <CardContent>
                ...
                <div className="space-y-3 max-w-md">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <label
                      ...
                      className="flex items-center gap-2 text-sm font-kabel"
                    >
            ...
            <div className="space-y-6">
              {usageGuidelines.map((guideline, index) => (
                <div key={index} className="p-4 glass-card rounded-lg">
                  <h4 className="font-semibold font-basement text-foreground mb-4">
                    {guideline.category}
                  </h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="text-sm font-medium font-basement text-success-500 mb-2">
                        ✓ Good Practices
                      </h5>
                    ...
                    <div>
                      <h5 className="text-sm font-medium font-basement text-error-500 mb-2">
                        ✗ Avoid
                      </h5>
                      <ul className="space-y-1">
