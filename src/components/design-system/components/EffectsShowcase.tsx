...
export function EffectsShowcase() {
  const [loadingVariant, setLoadingVariant] = useState<
    "spinner" | "cyberpunk" | "matrix" | "glitch"
  >("cyberpunk");
  ...
  const portfolioBentoItems = [
    {
      ...
      content: (
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold font-basement text-white mb-2">
            John Doe
          </h2>
          <p className="text-white/80 font-kabel">
    ...
    },
    {
      ...
      content: (
        <div className="text-center">
          <div className="text-3xl font-bold font-basement gradient-text mb-2">
            25+
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="text-center">
          ...
          <div className="text-lg font-bold font-basement text-foreground">
            1.2k
          </div>
  ...
  const dashboardBentoItems = [
    ...
    },
    {
      ...
      content: (
        <div className="text-center">
          <div className="text-lg font-bold font-basement text-success-500 mb-1">
            98%
          </div>
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Advanced visual effects, layout systems, and interactive components
          inspired by cyberpunk and modern design aesthetics.
        </p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardDescription className="font-kabel text-white/80">
            Smooth parallax scrolling for immersive visual experiences
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
                ...
                <p className="text-white/80 font-kabel text-sm mb-4">
                  Large background images with parallax scrolling effect. Scroll
                  down to see the effect in action.
                </p>
                ...
                >
                  <div className="text-center text-white">
                    <h3 className="text-4xl font-bold font-basement mb-4">
                      Parallax Hero Section
                    </h3>
                    <p className="text-xl font-kabel mb-6 max-w-2xl">
                      Experience smooth parallax scrolling that creates depth
                      and visual interest
                    </p>
              ...
              <div>
                <h4 className="font-medium font-basement text-white mb-4">
                  Content Parallax Grid
                </h4>
                <p className="text-white/80 font-kabel text-sm mb-4">
                  Grid of images with different sizes and parallax speeds. Each
                  image moves at a different rate.
                </p>
              ...
              <div>
                ...
                <p className="text-white/80 font-kabel text-sm mb-4">
                  Masonry layout with parallax effects for dynamic,
        ...
        <Card variant="glass" padding="lg">
          <CardTitle className="font-basement">
            Duo Tone Image Effects
          </CardTitle>
          <CardDescription className="font-kabel">
            Creative image treatments with color overlays and blend modes
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div>
                    <h5 className="text-sm font-basement text-foreground mb-2">
                      Default
                    </h5>
                    <DuoToneImage
                      src={sampleImages[0]}
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Flexible grid system inspired by Japanese bento boxes for dynamic
            layouts
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
                ...
                <BentoGrid items={portfolioBentoItems} columns={4} gap="md" />
              </div>
              ...
              <div>
                ...
                <BentoGrid items={dashboardBentoItems} columns={3} gap="lg" />
              </div>
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardDescription className="font-kabel text-white/80">
            Cyberpunk-inspired loading states and progress indicators
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div className="flex items-center gap-4 mb-6">
                <span className="text-white/80 font-kabel text-sm">
                  Variant:
                </span>
                <div className="flex gap-2">
                  {(["spinner", "cyberpunk", "matrix", "glitch"] as const).map(
                    (variant) => (
                      <button
                        key={variant}
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="text-center p-6 glass-card rounded-lg border border-white/20">
                    ...
                    <p className="text-white/80 font-kabel text-sm mt-3">
                      Spinner
                    </p>
                  </div>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Tech-inspired decorative components for visual enhancement
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <div className="relative p-8 glass-card rounded-lg">
                  ...
                  <div className="text-center">
                    <h5 className="font-basement text-foreground text-lg mb-2">
                      Decorated Content Area
                    </h5>
                    <p className="text-muted-foreground font-kabel">
                      Content with decorative corner elements for a cyberpunk
                      aesthetic
                    </p>
                  </div>
                </div>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Real-world applications of effects and layouts
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
                  ...
                  >
                    <div className="relative z-30 text-center p-8">
                      ...
                      <p className="text-white/90 font-kabel mb-6 max-w-2xl mx-auto">
                        ...
                        cyberpunk-inspired components, advanced visual effects,
                        and cutting-edge interaction patterns.
                      </p>
                ...
                <div className="relative p-8 glass-card rounded-lg overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <p className="text-muted-foreground font-kabel mb-6 max-w-2xl mx-auto">
                      Combine decorative elements with parallax effects for
                      stunning visual compositions that engage users and create
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {sampleImages.map((image, index) => (
                    <DuoToneImage
                      ...
                      variant={
                        ["default", "cyberpunk", "neon", "vintage"][
                          index
                        ] as any
                      }
                      className="aspect-square rounded-lg"
                  ...
                  >
                    <div className="text-center text-white">
                      <DecorativeElement
                        ...
                        animated={isAnimated}
                      />
                      <h4 className="text-2xl font-bold font-basement mt-4 mb-2">
                        Combined Effects
                      </h4>
                      <p className="font-kabel">
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            How these effects are built and optimized
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
              <div>
                <h4 className="font-semibold font-basement text-foreground mb-3">
                  Duo Tone Effect
                </h4>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold font-basement text-foreground mb-3 text-success-500">
                  ✓ Do
                </h4>
              ...
              <div>
                <h4 className="font-semibold font-basement text-foreground mb-3 text-error-500">
                  ✗ Don't
                </h4>
                <ul className="space-y-2 text-sm text-muted-foreground font-kabel">
