  ...
  const sampleBlogPosts = [
    {
      ...
      excerpt:
        "Learn how to create design systems that work for everyone, including users with disabilities. We'll cover WCAG guidelines, testing strategies, and implementation best practices.",
    ...
    },
    {
      ...
      excerpt:
        "Explore the latest React patterns and best practices that will make your code more maintainable, performant, and developer-friendly.",
    ...
    },
    {
      ...
      excerpt:
        "Understanding how colors affect user behavior and emotions can dramatically improve your interface design. Let's dive into color psychology.",
    ...
    },
    {
      ...
      excerpt:
        "Performance is crucial for user experience and SEO. Learn the latest techniques for building lightning-fast web applications.",
      author: sampleAuthors[1],
    ...
    },
    {
      ...
      excerpt:
        "Design tokens are the building blocks of consistent design systems. Learn how to implement and maintain them effectively.",
      author: sampleAuthors[0],
    ...
    },
    {
      ...
      excerpt:
        "Small animations and interactions can make a huge difference in user experience. Discover how to implement meaningful micro-interactions.",
      author: sampleAuthors[2],
  ...
  const sampleArticleContent = [
    {
      ...
      title: "Introduction",
      content:
        "Accessibility in design systems isn't just about compliance—it's about creating inclusive experiences that work for everyone. When we build with accessibility in mind from the start, we create better products for all users.",
      type: "text" as const,
    },
    {
      ...
      content:
        "Over 1 billion people worldwide live with some form of disability. That's 15% of the global population. When we ignore accessibility, we're excluding a significant portion of potential users.",
      type: "text" as const,
    },
    {
      id: "wcag-guidelines",
      ...
      content:
        "The Web Content Accessibility Guidelines (WCAG) provide a comprehensive framework for making web content accessible. Here are the four main principles:",
      type: "list" as const,
      list: {
...
export function Button({
  ...
  return (
    ...
    },
    {
      ...
      content:
        "Regular testing is crucial for maintaining accessibility standards. Here are some effective approaches:",
      type: "list" as const,
      list: {
    ...
    },
    {
      ...
      title: "Conclusion",
      content:
        "Building accessible design systems requires ongoing commitment and attention to detail. By following WCAG guidelines, testing regularly, and involving users with disabilities in our design process, we can create truly inclusive digital experiences.",
      type: "text" as const,
    },
  ];
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-lg text-muted-foreground font-kabel">
              Complete article layout with table of contents, author bio, and
              related articles
            </p>
          </div>
          <Button
          ...
          relatedArticles={[
            {
              ...
              excerpt:
                "Ensuring proper color contrast for accessibility compliance",
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Complete blog system with article layouts, author cards, pagination,
      ...
      <div className="grid gap-8">
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Article preview cards with multiple layout options
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Author profiles with social links, stats, and follow functionality
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
                <h4 className="font-medium font-basement text-foreground mb-4">
                  Default Author Cards
                </h4>
                <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardDescription className="font-kabel text-white/80">
            Navigation for large content sets with multiple variants
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Interactive blog listing with pagination and view modes
          </CardDescription>
          <CardContent>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center p-4 glass-card rounded-lg">
                ...
                <h4 className="font-basement text-foreground mb-2">
                  Rich Content
                </h4>
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold font-basement text-white mb-3">
                  ✓ Do
                </h4>
