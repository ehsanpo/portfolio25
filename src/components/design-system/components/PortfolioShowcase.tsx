...
export function PortfolioShowcase() {
  ...
  const sampleSkills = [
    ...
    },
    {
      ...
      description:
        "Server-side JavaScript with Express, APIs, and database integration",
    },
    {
      id: "figma",
      name: "Figma",
  ...
  const designProcess = [
    {
      ...
      details:
        "Deep dive into user behavior, market analysis, and stakeholder interviews to establish project foundation.",
      substeps: [
        {
    ...
    },
    {
      ...
      details:
        "Collaborative ideation sessions to generate and evaluate potential solutions.",
      substeps: [
        {
          title: "Brainstorming sessions",
          description: "Generate initial concepts",
          completed: true,
        },
        {
    ...
    },
    {
      ...
      details:
        "Transform concepts into detailed designs with focus on usability and visual appeal.",
      substeps: [
        {
          title: "Wireframing",
        ...
        {
          title: "Visual design",
          description: "Apply branding and styling",
          completed: false,
        },
        {
          title: "Prototyping",
    ...
    },
    {
      ...
      details:
        "Implement designs with focus on performance, accessibility, and scalability.",
      substeps: [
        {
          title: "Setup & architecture",
          description: "Project setup and architecture decisions",
          completed: false,
        },
        {
    ...
    },
    {
      ...
      details:
        "Comprehensive testing including functionality, usability, and performance validation.",
      substeps: [
        {
          title: "Unit testing",
    ...
    },
    {
      ...
      details:
        "Deploy to production with monitoring, analytics, and support documentation.",
      substeps: [
        {
  ...
  const sampleClients = [
    {
      ...
      duration: "6 months",
      testimonial:
        "Outstanding work on our platform redesign. The team delivered beyond expectations.",
      rating: 5,
      featured: true,
    ...
    },
    {
      ...
      duration: "8 months",
      testimonial:
        "Transformed our online presence and increased sales by 150%.",
      rating: 5,
      featured: true,
      status: "completed" as const,
      projectValue: "$75k",
    ...
    },
    {
      ...
      duration: "7 months",
      testimonial:
        "Excellent LMS that improved student engagement significantly.",
      rating: 5,
      featured: false,
      status: "completed" as const,
      projectValue: "$60k",
  ...
  const downloadItems = [
    {
      ...
      description:
        "Latest resume with current experience, skills, and achievements",
    ...
    },
    {
      ...
      description:
        "Complete portfolio with project highlights and case studies",
    ...
    },
    {
      ...
      description:
        "Comprehensive guide to building and maintaining design systems",
    ...
    },
    {
      ...
      description:
        "Official AWS certification for cloud architecture expertise",
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Specialized components designed for showcasing professional work,
      ...
      <div className="grid gap-8">
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardContent>
            <div className="space-y-8">
              <div>
                <h4 className="font-medium font-basement text-foreground mb-4">
                  Network View
                </h4>
                <TechStackVisualizer
                  skills={sampleSkills}
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Visual representation of work methodology and project phases
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="gradient" padding="lg">
          <CardTitle className="font-basement text-white">
            Client Logos Grid
          </CardTitle>
          <CardDescription className="font-kabel text-white/80">
            Showcase of clients and projects with filtering and detailed views
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
                <h4 className="font-medium font-basement text-white mb-4">
                  Logos Only View
                </h4>
                <ClientLogosGrid
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Professional documents and resources available for download
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Social sharing components for portfolio projects
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Portfolio project showcases with interactive features
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Professional skills showcase with proficiency levels
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardDescription className="font-kabel text-white/80">
            Customer testimonials with expandable content and social links
          </CardDescription>
          <CardContent>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Professional certifications and achievements with verification
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              <div>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Comprehensive project documentation with detailed breakdowns
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
              <div>
                  ...
                  sections={[
                    {
                      ...
                      content:
                        "We conducted extensive user interviews with 25 customers to understand pain points in the current shopping experience. Key findings revealed that users struggled with product discovery and the checkout process was too complex.",
                      highlights: [
                    ...
                    },
                    {
                      ...
                      content:
                        "Based on research insights, we created wireframes and high-fidelity prototypes. The new design focused on simplified navigation, streamlined checkout, and improved product discovery.",
                      highlights: [
      ...
      {steps.map((step, index) => (
        <CheckoutStep key={step} step={step} active={index === currentStep} />
                    ...
                    },
                    {
                      ...
                      content:
                        "The development phase focused on performance optimization, accessibility, and seamless integration with existing systems. We used React with TypeScript for type safety and Tailwind CSS for consistent styling.",
                      highlights: [
                  ...
                  outcomes={[
                    ...
                    },
                    {
                      ...
                      value: "4.8/5",
                      description: "Post-launch user rating",
                    },
                  ]}
                  challenges={[
