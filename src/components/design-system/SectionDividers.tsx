...
import { Scissors, Triangle, Smile, Zap, MoreHorizontal } from "lucide-react";
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Visual separators that create smooth transitions between content
          sections with various geometric patterns.
        </p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <p className="text-lg text-white/90 font-kabel leading-relaxed mb-6">
            Section dividers create visual rhythm and help organize content into
            digestible chunks. They should enhance the flow of information while
            adding visual interest without being distracting. Each divider style
            conveys a different mood and works best with specific content types.
          </p>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Different styles for various design contexts
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              {dividerTypes.map((divider) => {
                ...
                return (
                  <div key={divider.variant} className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-basement text-foreground text-lg">
                          {divider.name}
                        </h4>
                    ...
                    <div className="space-y-4">
                      {/* Normal */}
                      <div>
                        <div className="text-sm font-basement text-foreground mb-2">
                          Normal Direction
                        </div>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Different color variants for various backgrounds
          </CardDescription>
          <CardContent>
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardContent>
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="glass-card rounded-lg border border-white/20 overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-primary-500 to-secondary-500 p-8 text-center">
                    <h3 className="text-2xl font-bold font-basement text-white mb-2">
                      Hero Section
                    </h3>
                  ...
                  <div className="bg-background p-8 text-center">
                    <h3 className="text-xl font-basement text-foreground mb-2">
                      Content Section
                    </h3>
              ...
              <div>
                ...
                <div className="glass-card rounded-lg border border-white/20 overflow-hidden">
                  ...
                  <div className="bg-primary-500 p-8 text-center">
                    <h3 className="text-xl font-basement text-white mb-2">
                      Footer Section
                    </h3>
                    <p className="text-white/80 font-kabel">
                      Contact and links
              ...
              <div>
                <h4 className="font-medium font-basement text-white mb-4">
                  Multiple Section Flow
                </h4>
                <div className="glass-card rounded-lg border border-white/20 overflow-hidden">
                  {/* Section 1 */}
                  <div className="bg-background p-6 text-center">
                    <h4 className="font-basement text-foreground">
                      Section One
                    </h4>
                  </div>
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            How to use section dividers effectively
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
              <div>
...
<section className="bg-background">
  {/* Main content */}
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Try different combinations of dividers
          </CardDescription>
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="glass-card rounded-lg overflow-hidden">
                <div className="bg-gradient-to-r from-primary-500 to-secondary-500 p-8 text-center">
                  <h3 className="text-xl font-bold font-basement text-white mb-2">
                    Welcome Section
                  </h3>
                  <p className="text-white/80 font-kabel">
                ...
                <div className="bg-background p-8 text-center">
                  ...
                  <p className="text-muted-foreground font-kabel">
                    Main content with standard background
                  </p>
                </div>
