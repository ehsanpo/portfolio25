...
export function Accessibility() {
  ...
  const colorContrast = [
    ...
    },
    {
      level: "AAA Large",
      ratio: "4.5:1",
      description: "Enhanced for large text",
    },
  ];
  ...
  const ariaAttributes = [
    {
      ...
      usage: "Provides accessible name when visible text is insufficient",
    },
    {
      attribute: "aria-labelledby",
      usage: "References other elements that describe the current element",
    },
    {
      attribute: "aria-describedby",
      usage: "References elements that provide additional description",
    },
    {
      attribute: "aria-expanded",
      usage: "Indicates if a collapsible element is expanded",
    },
    {
      attribute: "aria-hidden",
      usage: "Hides decorative elements from screen readers",
    },
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Creating inclusive experiences that work for everyone, regardless of
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <p className="text-lg text-white/90 font-kabel leading-relaxed mb-6">
            ...
            We build for the full spectrum of human diversity, including people
            with disabilities, different devices, varying internet speeds, and
            diverse cultural contexts. When we design inclusively, we create
              ...
              <Card key={index} variant={variant} hover padding="lg">
                ...
                <ul className="space-y-2">
                  {principle.guidelines.map((guideline, idx) => (
                    <li
                      key={idx}
                      className="text-sm text-muted-foreground font-kabel flex items-start"
                    >
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            WCAG contrast ratio standards for text readability
          </CardDescription>
          <CardContent>
              ...
              {colorContrast.map((contrast, index) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-semibold font-basement text-foreground">
                        {contrast.ratio}
                      </div>
            ...
            <div className="mt-6 p-4 glass-card rounded-lg">
              ...
              <div className="grid md:grid-cols-3 gap-3">
                <div className="text-center p-3 bg-muted/30 rounded">
                  <div className="font-kabel text-sm text-foreground">
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Essential ARIA attributes for screen reader compatibility
          </CardDescription>
          <CardContent>
            <div className="space-y-4">
...
>
  <X aria-hidden="true" />
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Tools and techniques for testing with assistive technologies
          </CardDescription>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-4 glass-card rounded-lg text-center">
                ...
                <p className="text-xs text-muted-foreground font-kabel mb-2">
              ...
              <div className="p-4 glass-card rounded-lg text-center">
                ...
                <p className="text-xs text-muted-foreground font-kabel mb-2">
                  Professional Windows screen reader
                </p>
                <Badge variant="secondary" className="text-xs">
                  Windows
                </Badge>
