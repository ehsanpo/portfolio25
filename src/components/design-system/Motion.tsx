...
export function Motion() {
  ...
  const motionPrinciples = [
    ...
    },
    {
      title: "Natural",
      description:
        "Motion feels organic and follows real-world physics with appropriate easing curves.",
      example: "Cards ease out when appearing, like objects settling",
    },
    {
      title: "Responsive",
      description:
        "Animations adapt to user preferences and device capabilities.",
      example: "Reduced motion for accessibility preferences",
    },
    {
      title: "Performant",
      description:
        "Smooth 60fps animations that don't impact usability or battery life.",
  ...
  const easingCurves = [
    ...
    },
    {
      ...
      use: "Loading indicators and progress",
    },
  ];
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Thoughtful motion design that enhances usability, provides feedback,
          and creates delightful user experiences.
        </p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <p className="text-white/90 font-kabel mb-6">
            Our motion design follows these core principles to create meaningful
            and accessible animations.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {motionPrinciples.map((principle, index) => (
              ...
              >
                <h4 className="font-semibold font-basement text-white mb-2">
                  {principle.title}
                </h4>
                <p className="text-sm text-white/80 font-kabel mb-3">
                  {principle.description}
                </p>
                <p className="text-xs text-white/60 font-kabel italic">
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Different easing functions for different types of motion
          </CardDescription>
          <CardContent>
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className="w-16 h-8 bg-primary-500/20 rounded relative overflow-hidden">
                      <div
                        className={`w-2 h-2 bg-primary-500 rounded-full absolute top-3 ${
        ...
        <Card variant="default" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Consistent timing for different types of animations
          </CardDescription>
          <CardContent>
            <div className="mb-6 p-4 glass-card rounded-lg border border-warning-500/30 bg-warning-500/10">
              <h4 className="font-semibold font-basement text-warning-600 mb-2">
                ⚠️ Minimum Duration Rule
              </h4>
              <p className="text-sm text-muted-foreground font-kabel">
                All action animations must have a minimum duration of{" "}
                <strong>180ms</strong>. No action animation should be less than
                180ms to ensure users can perceive the feedback and maintain
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            Experience different types of motion in action
          </CardDescription>
          <CardContent>
            <div className="space-y-8">
              {/* Controls */}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Button
                    variant="outline"
                    className="transition-all duration-300 hover:border-primary-500"
                  >
                    Border on Hover
                  </Button>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <div className="flex items-center gap-2 p-3 glass-card rounded-lg">
                    ...
                    />
                    <span className="text-sm font-kabel text-foreground">
                      Processing...
                    </span>
                  </div>
                </div>
                  ...
                  {[1, 2, 3].map((item) => (
                    ...
                    >
                      <div className="p-4">
                        ...
                        <h5 className="font-basement text-foreground mb-1">
                          Card {item}
                        </h5>
                        <p className="text-xs text-muted-foreground font-kabel">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 glass-card rounded-lg border border-white/20">
                ...
                <p className="text-sm text-white/80 font-kabel mb-3">
                  Respect the prefers-reduced-motion media query to disable or
              ...
              <div className="p-4 glass-card rounded-lg border border-white/20">
                ...
                <p className="text-sm text-white/80 font-kabel">
                  Ensure focus states are clearly visible and that animations
