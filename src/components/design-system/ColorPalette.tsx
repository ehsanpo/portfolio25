...
export function ColorPalette() {
  const colorGroups = [
    ...
    },
    {
      ...
      description: "Custom brand colors for backgrounds and text",
    },
  ];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-neutral-600 mb-8">
          Our color system provides a comprehensive palette with semantic
          meaning and proper contrast ratios.
        </p>
      </div>
