...
type BadgeVariant = 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'neutral' | 'gradient' | 'glass';
...
const badgeVariants = {
  ...
  gradient: 'bg-gradient-to-r from-primary-500 to-secondary-500 text-white border-transparent',
