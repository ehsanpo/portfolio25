...
import { Heart, Lightbulb, Shield, Users, Zap } from "lucide-react";
    ...
    <div className="space-y-8">
      <div className="block-reveal">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-kabel">
          Our voice reflects our brand values and creates consistent, meaningful
          connections with users across all touchpoints.
        </p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <Card variant="gradient" padding="lg">
          ...
          <p className="text-lg text-white/90 font-kabel leading-relaxed mb-6">
            We speak with confidence and clarity, always putting the user first.
            Our tone is professional yet approachable, helpful without being
            condescending, and honest about both capabilities and limitations.
          </p>
        ...
        <Card variant="glass" padding="lg">
          ...
          <CardDescription className="font-kabel">
            How to apply our tone across different types of content
          </CardDescription>
          <CardContent>
              ...
              {contentTypes.map((content, index) => (
                <div key={index} className="p-4 glass-card rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="font-medium font-basement text-foreground">
                      {content.type}
                    </h4>
        ...
        <Card variant="gradient" padding="lg">
          ...
          <CardDescription className="font-kabel text-white/80 mb-6">
            Use this checklist to ensure your content aligns with our brand
            voice
          </CardDescription>
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-white/90 font-kabel">
