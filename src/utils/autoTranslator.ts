...
class AutoTranslator {
  ...
  private async translateWithOpenAI(request: TranslationRequest): Promise<TranslationResult> {
    if (!this.apiKey) {
...
export function configureTranslator(provider: TranslationProvider, apiKey: string) {
